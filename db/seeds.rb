...
promos = [
  ...
  {
    title: "Лишенные голоса: волонтеры спасли собак",
...
Когда их обнаружили волонтеры, собаки были в критическом состоянии. Животных забрали и через объявления в соцсетях нашли им хозяев. Перед отправкой в новый дом собакам оказали ветеринарную помощь. Одну из них спасти не удалось. Из-за серьезных проблем со здоровьем двухлетняя Линда погибла.",
  ...
  {
    title: "В Подмосковье ввели штрафы за нарушение правил выгула собак",
    content: "Депутаты Мособлдумы внесли изменения в КоАП Московской области, согласно которым хозяев собак будут ждать штрафы в размере до 5 тыс. рублей за нарушение правил выгула питомцев.
По итогам заседания, которое состоялось 27 мая, Мособлдума внесла изменения в региональный КоАП и ввела штрафные санкции в размере от 500 рублей до 5 тыс. рублей.",
    user_id: User.all.ids[0],
    image: File.open(Rails.root.join('public', 'images', 'bezdomni.png')),
  }
]
